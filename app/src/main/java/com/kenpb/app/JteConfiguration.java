...
public class JteConfiguration {
    ...
    public TemplateEngine templateEngine() {
        ...
        if ("prod".equals(profile)) {
            ...
            // Here, a JTE file watcher will recompile the JTE templates upon file save (the
            // web browser will auto-refresh)
            // If using IntelliJ, use Ctrl-F9 to trigger an auto-refresh when editing
            // non-JTE files.
            CodeResolver codeResolver = new CustomCodeResolver(new Path[] {
                Path.of("/workspaces/sbp_demo/app/src/main/jte"),
                Path.of("/workspaces/sbp_demo/plugins/sample_plugin/src/main/jte")
            });
